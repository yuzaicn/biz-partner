...
SOURCE_IDENTITY_FILE = "public-knowledge/sources.jsonl"
...
def main() -> int:
    ...
    required = set(('LICENSE', 'SKILL.md', 'agents/openai.yaml', 'evals/debate-events-valid.jsonl', 'evals/invalid-completed-no-evidence.json', 'evals/routing-cases.jsonl', 'evals/safety-cases.jsonl', 'evals/valid-handoff.json', 'public-knowledge/USAGE.md', 'public-knowledge/atoms.jsonl', 'public-knowledge/book-metadata.md', 'public-knowledge/concept-dictionary.md', 'public-knowledge/concepts.jsonl', 'public-knowledge/manifest.json', 'public-knowledge/methods.md', 'public-knowledge/retrieval-cases.jsonl', 'public-knowledge/sources.jsonl', 'references/business-product-playbooks.md', 'references/content-safety.md', 'references/debate-protocol.md', 'references/knowledge-governance.md', 'references/knowledge-runtime.md', 'references/memory-governance.md', 'references/output-contract.md', 'references/personal-content-governance-playbooks.md', 'references/runtime-kernel.md', 'references/schemas/case-packet.schema.json', 'references/schemas/handoff.schema.json', 'references/schemas/memory-proposal.schema.json', 'references/script-operations.md', 'references/source-attribution.md', 'references/task-registry.md', 'references/task-specs.jsonl', 'references/workbench-runtime.md', 'scripts/adaptive_context.py', 'scripts/atom_contract.py', 'scripts/audit_skill.py', 'scripts/freeze_contract_bundle.py', 'scripts/knowledge_runtime.py', 'scripts/render_source_attribution.py', 'scripts/route_task.py', 'scripts/state_store.py', 'scripts/test_adaptive_context.py', 'scripts/test_atom_contract.py', 'scripts/test_audit_skill.py', 'scripts/test_contracts.py', 'scripts/test_debate.py', 'scripts/test_freeze_contract_bundle.py', 'scripts/test_knowledge_runtime.py', 'scripts/test_render_source_attribution.py', 'scripts/test_route_task.py', 'scripts/test_state_store.py', 'scripts/test_validate_public_knowledge.py', 'scripts/test_workbench_runtime.py', 'scripts/validate_contracts.py', 'scripts/validate_debate.py', 'scripts/validate_public_knowledge.py', 'scripts/validate_public_runtime.py', 'scripts/validate_tasks.py', 'scripts/workbench_runtime.py', 'templates/decision-record.json', 'templates/profile-proposal.json', 'templates/project-state.json', 'templates/workbench-config.json'))
    existing = {
    ...
    for path in sorted(root.rglob("*")):
        ...
        for identity in sorted(SOURCE_IDENTITY_TEXT):
            if identity.casefold() in text.casefold() and relative.as_posix() != SOURCE_IDENTITY_FILE:
                trace_findings += 1
